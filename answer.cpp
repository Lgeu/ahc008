...
void ComputeReward() {
    ...
    rep(idx_human, common::M) {
        ...
        // あああああああああ
        if (features::distances_from_each_human[features::max_area_human][common::human_positions[idx_human]] != 999 && features::max_area >= 100) {
